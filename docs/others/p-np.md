...
──可以在多项式时间==找出解==的问题[^decision-problem]
...
了解了 **NP 完全**问题之后，**NP-hard** 问题就很好理解了：~~① 是 **NP** 问题~~（不要求），<span style="color: #F26400">①</span> 所有的 **NP** 问题都能（在多项式时间内）归约为它。换句话说，**NP-hard** 问题是**至少和 NP 完全问题一样难**的问题（而 **NP 完全**问题是 **NP 问题中最难的**那部分问题）
